...
<template>
  <section class="values" id="contato">
...
.values__image {
  width: 100%;
  border-radius: 24px;
  box-shadow: 0 20px 42px rgba(138, 82, 39, 0.2);
  object-fit: cover;
}
...
.values__cta {
  ...
  box-shadow: 0 12px 28px rgba(138, 82, 39, 0.18);
...
.values__cta:focus {
  ...
  box-shadow: 0 16px 32px rgba(138, 82, 39, 0.22);
}
